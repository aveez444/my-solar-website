...
import bipvImage from '/src/assets/images/Building integrated_1.jpg';
import bipvImage2 from '/src/assets/images/Building integrated_2.jpg';
  ...
  const benefits = [
    {
      ...
      desc: "Transforms roofs, facades, and windows into sleek, energy-generating features",
      icon: "🎨"
    },
    {
      title: "Save on Bills",
      desc: "Cuts electricity costs by up to 30% with integrated solar power",
      icon: "💰"
    },
    {
      title: "Eco-Friendly Living",
      desc: "Reduces carbon emissions, supporting a greener planet",
      icon: "🌍"
    },
    {
      title: "Future-Proof Value",
      desc: "Boosts property value with sustainable, modern technology",
      icon: "📈"
    }
  ];
  ...
  const howItWorks = [
    {
      ...
      desc: "Solar panels in building materials generate clean electricity",
      visual: "☀️→⚡"
    },
    {
      step: "2",
      title: "Convert Power",
      desc: "Inverters turn solar energy into usable electricity",
      visual: "🔌⇨🏠"
    },
    {
      step: "3",
      title: "Power Your Space",
      desc: "Energizes your home or business directly",
      visual: "🏠⚡"
    },
    {
      step: "4",
      title: "Earn Credits",
      desc: "Send excess power to the grid for savings",
      visual: "🏠⇄🏙️"
    }
  ];
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          >
            <div className="inline-flex items-center px-4 py-2 bg-green-500/20 rounded-full mb-6">
              <span className="text-green-400 font-medium">Power Your Future</span>
            </div>
            <motion.h1 
            ...
            >
              <span className="text-green-400">BiPV</span> Solar Systems
            </motion.h1>
            <motion.p 
            ...
            >
              Beautiful, sustainable energy for modern buildings
            </motion.p>
            <motion.div
              variants={fadeInUp}
            ...
            <div className="lg:w-2/3">
              ...
              >
                ...
                <div className="absolute -bottom-6 -right-6 bg-white p-6 rounded-xl shadow-lg border border-gray-100">
                  <div className="text-3xl font-bold text-green-600">$2,000/kW</div>
              ...
              >
                <div className="inline-block px-4 py-2 bg-green-100 rounded-full mb-4">
                  <span className="text-green-700 font-medium">What is BiPV?</span>
                </div>
                <h2 className="text-4xl md:text-5xl font-bold text-gray-900 leading-tight">
                  Solar-Powered <span className="text-green-600">Architecture</span>
                </h2>
                <p className="text-lg text-gray-600">
                  BiPV systems turn building elements like roofs, windows, and facades into solar power generators. With an average cost of $2,000 per kW, they blend cutting-edge technology with stunning design, saving energy and boosting property value.
                </p>
                ...
                <div className="space-y-6">
                  <div className="flex items-start p-6 bg-white rounded-xl shadow-sm border border-gray-100">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="text-gray-600">
                        Produces electricity from sunlight, slashing utility bills.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start p-6 bg-white rounded-xl shadow-sm border border-gray-100">
                    ...
                    <div className="ml-4">
                      <h3 className="text-xl font-bold text-gray-800 mb-2">Modern Aesthetics</h3>
                      <p className="text-gray-600">
                        Elevates building design with sleek, customizable solar panels.
                      </p>
                    </div>
                  </div>
                </div>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <motion.div 
              ...
              data-aos="fade-up"
            >
              <span className="text-green-700 font-medium">Why BiPV?</span>
            </motion.div>
            <motion.h2 
              ...
              data-aos-delay="100"
            >
              <span className="text-green-600">Transform</span> Your Building
            </motion.h2>
          </div>
          ...
          <div className="mt-16 bg-white rounded-2xl shadow-lg overflow-hidden max-w-4xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2">
              <div className="bg-green-600 p-8 text-white">
                <h3 className="text-2xl font-bold mb-4">Green Today, Thriving Tomorrow</h3>
                <p className="mb-6">
                  BiPV systems cut carbon emissions by up to 50 tons per year for a typical commercial building.
                </p>
                <ul className="space-y-3">
                  <li className="flex items-start">
                    ...
                    <span>Aligns with LEED and net-zero standards</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="w-5 h-5 mt-0.5 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                    </svg>
                    <span>Powers a sustainable future</span>
                  </li>
                </ul>
              </div>
              <div className="p-8">
                ...
                <p className="text-gray-600 mb-6">
                  With costs at ~$2,000/kW, BiPV systems pay back in 8-12 years while boosting property value.
                </p>
                <div className="flex items-center">
                  ...
                  <p className="text-gray-700 font-medium">
                    "BiPV adds up to 6% to property value"
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <motion.h2 
              ...
              data-aos-delay="100"
            >
              BiPV <span className="text-green-600">Made Simple</span>
            </motion.h2>
            <motion.p
              ...
              data-aos-delay="200"
            >
              See how BiPV turns your building into a solar powerhouse
            </motion.p>
          </div>
      ...
      <section className="py-20 bg-gradient-to-r from-green-600 to-green-700 text-white">
        <div className="container mx-auto px-6 text-center">
          <motion.div 
            ...
            data-aos="zoom-in"
          >
            <h2 className="text-4xl md:text-5xl font-bold mb-6">Go Solar with Style</h2>
            <p className="text-xl mb-8 opacity-90">
              Let our experts design a BiPV system that powers your building and elevates its look.
            </p>
            <motion.div
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
