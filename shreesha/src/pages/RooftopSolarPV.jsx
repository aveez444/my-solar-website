...
import rooftopImage1 from "/src/assets/images/Rooftop_1.jpg";
import rooftopImage2 from "/src/assets/images/Rooftop_2.jpg";
  ...
  const benefits = [
    {
      ...
      desc: "Significantly lowers greenhouse gas emissions",
      icon: "🌍"
    },
    {
      title: "Cost Savings",
      desc: "Reduces electricity bills with competitive installation costs",
      icon: "💰"
    },
    {
      title: "Energy Independence",
      desc: "Generates power on-site, reducing reliance on fossil fuels",
      icon: "🏠"
    },
    {
      title: "Scalability",
      desc: "Easily expandable for residential to industrial applications",
      icon: "📈"
    }
  ];
  ...
  const howItWorks = [
    {
      step: "1",
      title: "Solar Capture",
      desc: "Panels convert sunlight into electricity using photovoltaic cells",
      visual: "☀️→⚡"
    },
    {
      step: "2",
      title: "Power Conversion",
      desc: "Inverters transform DC electricity to usable AC power",
      visual: "🔌⇨🏠"
    },
    {
      step: "3",
      title: "Energy Usage",
      desc: "Powers your home or business directly from the roof",
      visual: "🏠⚡"
    },
    {
      step: "4",
...
/>
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          >
            ...
            >
              <span className="text-green-400">Rooftop Solar</span> Photovoltaic Systems
            </motion.h1>
            <motion.p
            ...
            >
              Clean, sustainable energy from your rooftop
            </motion.p>
            <motion.div
              variants={fadeInUp}
...
/>
                ...
                <div className="absolute -bottom-6 -right-6 bg-white p-6 rounded-xl shadow-lg border border-gray-100">
                  ...
                  <div className="text-gray-600">Global PV Capacity</div>
                </div>
              </motion.div>
              ...
              >
                <div className="inline-block px-4 py-2 bg-green-100 rounded-full mb-4">
                  <span className="text-green-700 font-medium">What is RSPVS?</span>
                </div>
                <h2 className="text-4xl md:text-5xl font-bold text-gray-900 leading-tight">
                  Sustainable <span className="text-green-600">Energy</span> Solution
                </h2>
                <p className="text-lg text-gray-600">
                  Rooftop Solar Photovoltaic Systems (RSPVS) are solar panels installed on building rooftops to generate electricity from sunlight. They contribute to 40% of global solar PV capacity, offering a decentralized solution to reduce carbon emissions and promote renewable energy adoption.
                </p>
                ...
                <div className="space-y-6">
                  <div className="flex items-start p-6 bg-white rounded-xl shadow-sm border border-gray-100">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="text-gray-600">
                        Converts sunlight into electricity, reducing reliance on fossil fuels.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start p-6 bg-white rounded-xl shadow-sm border border-gray-100">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="text-gray-600">
                        Cuts CO2 emissions by over 860 million tons annually as of 2020.
                      </p>
                    </div>
                  </div>
                </div>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <motion.h2
              ...
              data-aos-delay="100"
            >
              <span className="text-green-600">Why Choose</span> RSPVS
            </motion.h2>
          </div>
          ...
          <div className="mt-16 bg-white rounded-2xl shadow-lg overflow-hidden max-w-4xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2">
              <div className="bg-green-600 p-8 text-white">
                ...
                <p className="mb-6">
                  RSPVS can reduce CO2 emissions by millions of tons annually, contributing to global climate goals.
                </p>
                <ul className="space-y-3">
                  <li className="flex items-start">
                    ...
                    <span>Over 860 million tons of CO2 saved by 2020</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="w-5 h-5 mt-0.5 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
              ...
              <div className="p-8">
                ...
                <p className="text-gray-600 mb-6">
                  Installation costs have dropped by over 80% in the last decade, making RSPVS highly competitive.
                </p>
                <div className="flex items-center">
                  ...
                  <p className="text-gray-700 font-medium">
                    "RSPVS can be installed for as low as $1 per watt"
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <motion.h2
              ...
              data-aos-delay="100"
            >
              How RSPVS <span className="text-green-600">Works</span>
            </motion.h2>
            <motion.p
              ...
              data-aos-delay="200"
            >
              Understand the seamless process of generating solar power from your rooftop
            </motion.p>
          </div>
        ...
        <div className="container mx-auto px-6 text-center">
          ...
          >
            ...
            <p className="text-xl mb-8 opacity-90">
              Our experts will help you harness the power of the sun with a custom RSPVS solution.
            </p>
            <motion.div
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
