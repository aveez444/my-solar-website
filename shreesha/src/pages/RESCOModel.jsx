...
import rescoModelImage from "/src/assets/images/RESCO Model_1.jpg";
import rescoModelImage2 from "/src/assets/images/RESCO Model_2.jpg";
...
const RESCOModel = () => {
  ...
  const features = [
    {
      ...
      desc: 'No capital investment required from the client',
      color: 'from-emerald-500 to-green-600'
    },
    {
      icon: '📉',
      title: 'Discounted Tariff',
      desc: 'Pay lower rates than DISCOM tariffs',
      color: 'from-lime-500 to-green-500'
    },
    {
      icon: '🛠️',
      title: 'Full O&M Support',
      desc: 'RESCO handles all operations and maintenance',
      color: 'from-teal-500 to-emerald-500'
    },
    {
      icon: '📝',
      title: 'Long-Term PPA',
      desc: 'Secure energy costs with a Power Purchase Agreement',
  ...
  const advantages = [
    {
      title: 'No Capital Burden',
      desc: 'Access solar power without upfront investment',
      icon: '💰'
    },
    {
      title: 'Predictable Costs',
      desc: 'Fixed per-unit pricing for budget stability',
      icon: '📊'
    },
    {
      title: 'Hassle-Free',
      desc: 'RESCO manages installation and maintenance',
      icon: '🔧'
    },
    {
  ...
  const howItWorks = [
    {
      ...
      desc: 'Assess client’s financial stability and energy needs',
      visual: '📋'
    },
    {
      step: '2',
      title: 'PPA Signing',
      desc: 'Sign a Power Purchase Agreement with agreed tariff',
      visual: '📝'
    },
    {
      step: '3',
      title: 'System Installation',
      desc: 'RESCO installs the solar plant on client’s space',
      visual: '🔧'
    },
    {
      step: '4',
      title: 'Power Consumption',
      desc: 'Client pays per unit for consumed electricity',
      visual: '⚡'
    }
  ];
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          >
            <div className="inline-block px-4 py-2 bg-green-500/20 rounded-full mb-6">
              <span className="text-green-400 font-medium">Pay as You Go</span>
            </div>
            <motion.h1 
            ...
            >
              RESCO/BOOT <span className="text-green-400">Model</span>
            </motion.h1>
            <motion.p 
            ...
            >
              Solar power with zero upfront costs
            </motion.p>
            <motion.div
              variants={fadeInUp}
...
<img
  src={rescoModelImage2}
  alt="RESCO Solar Installation"
...
/>
              ...
              >
                <div className="inline-block px-4 py-2 bg-green-100 rounded-full mb-4">
                  <span className="text-green-700 font-medium">What is RESCO?</span>
                </div>
                <h2 className="text-4xl md:text-5xl font-bold text-gray-900 leading-tight">
                  Solar Power, <span className="text-green-600">No Investment</span>
                </h2>
                <p className="text-lg text-gray-600">
                  The RESCO (Renewable Energy Service Company) or BOOT (Build, Own, Operate, Transfer) model allows customers to access solar power without any upfront costs. The EPC developer or investor funds the entire capital expenditure to set up the solar power plant on the client’s premises and covers all operation and maintenance (O&M) expenses. In return, the client signs a long-term Power Purchase Agreement (PPA) and pays a discounted tariff per unit of electricity consumed, lower than existing DISCOM rates.
                </p>
                <p className="text-lg text-gray-600">
                  The RESCO model requires careful evaluation of the client’s financial stability, creditworthiness, and payment history to ensure regular payments to the investor, who retains ownership of the solar plant.
                </p>
                ...
                <div className="space-y-6">
                  <div className="flex items-start p-6 bg-white rounded-xl shadow-sm border border-gray-100">
                    ...
                    <div className="ml-4">
                      <h3 className="text-xl font-bold text-gray-800 mb-2">Zero Upfront Costs</h3>
                      <p className="text-gray-600">
                        Pay only for the electricity you consume at a discounted rate.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start p-6 bg-white rounded-xl shadow-sm border border-gray-100">
                    ...
                    <div className="ml-4">
                      <h3 className="text-xl font-bold text-gray-800 mb-2">Hassle-Free Maintenance</h3>
                      <p className="text-gray-600">
                        RESCO handles all O&M, ensuring optimal performance.
                      </p>
                    </div>
                  </div>
                </div>
        ...
        <div className="bg-white p-8 rounded-xl shadow-xl border border-gray-100 sticky">
          ...
          <div className="space-y-4 mb-8">
            {[
              ...
              {name: "RESCO/BOOT Model", link: "/resco", active: true},
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <motion.h2 
              ...
              data-aos-delay="100"
            >
              Why Choose <span className="text-green-600">RESCO/BOOT</span>
            </motion.h2>
          </div>
          ...
          <div className="mt-16 bg-white rounded-2xl shadow-lg overflow-hidden max-w-4xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2">
              <div className="bg-green-600 p-8 text-white">
                <h3 className="text-2xl font-bold mb-4">Affordable Solar Power</h3>
                <p className="mb-6">
                  Pay only for the electricity you use at a discounted rate, with no upfront costs.
                </p>
                <ul className="space-y-3">
                  <li className="flex items-start">
                    ...
                    <span>Lower per-unit costs than DISCOM tariffs</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="w-5 h-5 mt-0.5 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 29">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                    </svg>
              ...
              <div className="p-8">
                <h3 className="text-2xl font-bold text-gray-800 mb-4">Effortless Transition</h3>
                <p className="text-gray-600 mb-6">
                  RESCO manages everything, from installation to maintenance, for a seamless experience.
                </p>
                <div className="flex items-center">
                  ...
                  <p className="text-gray-700 font-medium">
                    "RESCO makes solar accessible with zero investment"
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <motion.h2 
              ...
              data-aos-delay="100"
            >
              Your Path to <span className="text-green-600">RESCO Solar</span>
            </motion.h2>
            <motion.p
              ...
              data-aos-delay="200"
            >
              Understand the simple steps to adopt the RESCO model
            </motion.p>
          </div>
      ...
      <section className="py-20 bg-gradient-to-r from-green-600 to-green-700 text-white">
        <div className="container mx-auto px-6 text-center">
          <motion.div 
            ...
            data-aos="zoom-in"
          >
            <h2 className="text-4xl md:text-5xl font-bold mb-6">Ready for Affordable Solar?</h2>
            <p className="text-xl mb-8 opacity-90">
              Our RESCO experts will guide you to solar power with no upfront costs and maximum savings.
            </p>
            <motion.div
            ...
            >
              ...
              >
                Get Your Free RESCO Consultation
                <svg className="w-5 h-5 ml-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 5l7 7m0 0l-7 7m7-7H3" />
                </svg>
              </a>
