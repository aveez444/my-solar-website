...
import deferredCapexImage from "/src/assets/images/Deferred CAPEX Model_1.jpg";
import deferredCapexImage2 from "/src/assets/images/Deferred CAPEX Model_2.jpg";

const DeferredCAPEXModel = () => {
  useEffect(() => {
    AOS.init({
      duration: 1000,
      once: true,
  ...
  const features = [
    {
      ...
      desc: 'Own the solar system outright',
      color: 'from-emerald-500 to-green-600'
    },
    {
      icon: '💸',
      title: 'Flexible Payments',
      desc: 'Pay balance in 4-5 equal installments',
    ...
    },
    {
      ...
      desc: 'Balance financed by developer or bank',
  ...
  const advantages = [
    {
      ...
      desc: 'Spread capital costs over manageable installments',
      icon: '💰'
    },
    {
      title: 'Energy Savings',
      desc: 'Reduce electricity bills while owning the system',
      icon: '⚡'
    },
    {
    ...
    },
    {
      ...
      desc: 'Contribute to a greener future with solar',
      icon: '🌿'
    }
  ];
  ...
  const howItWorks = [
    {
      ...
      desc: 'Contribute minimum 30% as margin money',
      visual: '💸'
    },
    {
      step: '2',
      title: 'Financing Agreement',
      desc: 'Secure loan for balance, payable in 4-5 installments',
      visual: '📝'
    },
    {
      step: '3',
    ...
    {
      step: '4',
      title: 'Ownership & Savings',
      desc: 'Own the system and save on electricity costs',
      visual: '⚡'
    }
  ];
...
<img 
  src={deferredCapexImage} 
  alt="Deferred CAPEX Model" 
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          >
            <div className="inline-block px-4 py-2 bg-green-500/20 rounded-full mb-6">
              <span className="text-green-400 font-medium">Flexible Solar Ownership</span>
            </div>
            <motion.h1 
            ...
            >
              Deferred CAPEX <span className="text-green-400">Model</span>
            </motion.h1>
            <motion.p 
            ...
            >
              Own your solar system with flexible payments
            </motion.p>
            <motion.div
              variants={fadeInUp}
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="flex flex-col lg:flex-row gap-12">
            <div className="lg:w-2/3">
              ...
              >
<img
  src={deferredCapexImage2}
  alt="Deferred CAPEX Solar Installation"
  className="w-full h-full object-cover"
/>
              ...
              >
                <div className="inline-block px-4 py-2 bg-green-100 rounded-full mb-4">
                  <span className="text-green-700 font-medium">What is Deferred CAPEX?</span>
                </div>
                <h2 className="text-4xl md:text-5xl font-bold text-gray-900 leading-tight">
                  Flexible <span className="text-green-600">Solar Ownership</span>
                </h2>
                <p className="text-lg text-gray-600">
                  The Deferred CAPEX Model allows customers to own a solar power system by paying a minimum 30% initial margin toward the capital expenditure, with the balance financed as a loan by a financier or developer. The remaining amount is repaid in 4-5 equal installments, making it easier to manage costs while gaining full ownership of the solar asset.
                </p>
                <p className="text-lg text-gray-600">
                  Customers can claim accelerated depreciation benefits, reducing tax liabilities, and enjoy significant energy savings, making this model ideal for businesses seeking to spread capital costs over time.
                </p>
                ...
                <div className="space-y-6">
                  <div className="flex items-start p-6 bg-white rounded-xl shadow-sm border border-gray-100">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="text-gray-600">
                        Gain full ownership with a flexible payment plan.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start p-6 bg-white rounded-xl shadow-sm border border-gray-100">
                    ...
                    <div className="ml-4">
                      <h3 className="text-xl font-bold text-gray-800 mb-2">Manageable Installments</h3>
                      <p className="text-gray-600">
                        Pay the balance in 4-5 equal installments.
                      </p>
                    </div>
                  </div>
                </div>
        ...
        <div className="bg-white p-8 rounded-xl shadow-xl border border-gray-100 sticky">
          ...
          <div className="space-y-4 mb-8">
            {[
              ...
              {name: "Deferred CAPEX Model", link: "/deferred", active: true}
            ].map((item, index) => (
              <a
                key={index}
                href={item.link}
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <motion.h2 
              ...
              data-aos-delay="100"
            >
              Why Choose <span className="text-green-600">Deferred CAPEX</span>
            </motion.h2>
          </div>
          ...
          <div className="mt-16 bg-white rounded-2xl shadow-lg overflow-hidden max-w-4xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2">
              <div className="bg-green-600 p-8 text-white">
                <h3 className="text-2xl font-bold mb-4">Flexible Ownership</h3>
                <p className="mb-6">
                  Own your solar system with a low initial payment and manageable installments, plus tax benefits.
                </p>
                <ul className="space-y-3">
                  <li className="flex items-start">
                    ...
                    <span>Only 30% upfront payment</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="w-5 h-5 mt-0.5 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
              ...
              <div className="p-8">
                ...
                <p className="text-gray-600 mb-6">
                  Shreesha supports you with installation and financing for a hassle-free experience.
                </p>
                <div className="flex items-center">
                  ...
                  <p className="text-gray-700 font-medium">
                    "Deferred CAPEX makes solar ownership simple and affordable"
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <motion.h2 
              ...
              data-aos-delay="100"
            >
              Your Path to <span className="text-green-600">Deferred CAPEX Solar</span>
            </motion.h2>
            <motion.p
              ...
              data-aos-delay="200"
            >
              Discover the steps to own your solar system with flexible payments
            </motion.p>
          </div>
      ...
      <section className="py-20 bg-gradient-to-r from-green-600 to-green-700 text-white">
        <div className="container mx-auto px-6 text-center">
          <motion.div 
            ...
            data-aos="zoom-in"
          >
            <h2 className="text-4xl md:text-5xl font-bold mb-6">Ready to Own Solar with Deferred Payments?</h2>
            <p className="text-xl mb-8 opacity-90">
              Contact our team to explore the Deferred CAPEX Model and start your solar journey today.
            </p>
            <motion.div
            ...
            >
              ...
              >
                Get Your Free Deferred CAPEX Consultation
                <svg className="w-5 h-5 ml-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 5l7 7m0 0l-7 7m7-7H3" />
                </svg>
              </a>
...
export default DeferredCAPEXModel;