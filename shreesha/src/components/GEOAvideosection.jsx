import videoUrl from '../assets/videos/GreenEnergyServices.mp4';

const GEOAVideosection = () => {
  const handleDownload = () => {
    // Create a temporary anchor element
    const link = document.createElement('a');
    link.href = videoUrl;
    link.download = 'GreenEnergyServices.mp4'; // Suggested filename
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12">
          ...
          <div className="lg:w-1/2" data-aos="fade-left">
            ...
            <h2 className="text-4xl font-bold text-gray-900 mb-6">
              Want to <span className="text-green-600">deeply understand</span> Our Services ?
            </h2>
...
export default GEOAVideosection;