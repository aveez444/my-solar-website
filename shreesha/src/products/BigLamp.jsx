...
const BigLamp = () => {
    const product = {
      ...
      benefits: [
        'Powerful 5W output illuminates large areas effectively',
        '12-hour continuous operation for all-night security',
        'IP65 rating ensures durability in all weather conditions',
        'High-efficiency solar panel charges quickly even on cloudy days',
       
      ],
      images: [BigNightLamp, BigNightLamp2],
      reviews: [
        { name: 'Rajesh M.', rating: 5, comment: 'Extremely bright! Lights up my entire driveway. The 12-hour backup is amazing.' },
        { name: 'Priya S.', rating: 5, comment: 'Perfect for our backyard. Waterproof design survived heavy rains!' },
        { name: 'Vikram K.', rating: 4, comment: 'Great value for money. Much brighter than expected for the price.' }
      ]
    };
      ...
      >
        ...
        >
          ...
          <div className="relative z-10">
            ...
            >
              <p className="mb-4">
                Our Corporate Gifting program is designed for bulk orders with a <strong>minimum quantity of 20 units</strong>. 
              </p>
              <p className="mb-4">
