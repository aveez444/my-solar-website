...
const BigLamp = () => {
    const product = {
      ...
      features: [
        { icon: FiSun, title: 'High Power 5W', desc: '5W solar panel for faster charging and brighter illumination' },
        { icon: FiBatteryCharging, title: '12-Hour Backup', desc: 'Extended 12-hour runtime on a full charge for all-night lighting' },
        { icon: FaLeaf, title: 'Eco-Friendly', desc: 'Zero electricity consumption, completely solar-powered' },
        { icon: FiDroplet, title: 'IP65 Waterproof', desc: 'Fully waterproof design for harsh weather conditions' },
        { icon: FiZap, title: 'High Lumen Output', desc: 'Super bright LEDs for maximum illumination coverage' },
        { icon: FiShield, title: '3-Year Warranty', desc: 'Extended 3-year warranty for peace of mind' }
      ],
      benefits: [
        ...
        'Perfect for driveways, large gardens, and security lighting',
        'Motion sensor option available for enhanced security features'
      ],
      images: [BigNightLamp],
      reviews: [
