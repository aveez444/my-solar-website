...
const CarDiya = () => {
    const product = {
        ...
        images: [SolarCarDiya1, SolarCarDiya2, SolarCarDiya3],
        reviews: [
          { 
            name: 'Rajesh T.', 
            rating: 5, 
                    ...
                    <div className="space-y-2 sm:space-y-3">
                      ...
                      <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-1 sm:gap-2">
                        ...
                        <motion.button
                          ...
                          className="flex-1 bg-gradient-to-r from-emerald-500 to-green-600 text-white px-6 sm:px-8 py-3 sm:py-3 rounded-lg font-bold shadow-md hover:shadow-emerald-500/25 transition-all duration-300 flex items-center justify-center text-sm sm:text-base"
                        >
                          Buy Now 
                ...
                <div className="space-y-2 sm:space-y-3">
                  ...
                  <div className="flex justify-between mt-2 sm:mt-3">
                    ...
                    <motion.button
                      ...
                      className="bg-gradient-to-r from-emerald-500 to-green-600 text-white px-3 sm:px-4 py-1.5 sm:py-2 rounded-lg font-bold shadow-md hover:shadow-emerald-500/25 transition-all duration-300 flex items-center text-xs sm:text-sm"
                      whileHover={{ scale: 1.03 }}
                      whileTap={{ scale: 0.95 }}
                    >
                ...
                <form className="space-y-2 sm:space-y-3">
                  ...
                  <div className="flex justify-between mt-2 sm:mt-3">
                    ...
                    <motion.button
                      ...
                      disabled={isSending}
                      className="bg-gradient-to-r from-emerald-500 to-green-600 text-white px-3 sm:px-4 py-1.5 sm:py-2 rounded-lg font-bold shadow-md hover:shadow-emerald-500/25 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed flex items-center text-xs sm:text-sm"
