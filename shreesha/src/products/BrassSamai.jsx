...
const BrassSamai = () => {
    const product = {
        ...
        features: [
          { icon: FiSun, title: 'Solar Powered', desc: 'High-efficiency solar panel provides free energy with daylight charging' },
          { icon: FiBatteryCharging, title: '12-Hour Runtime', desc: 'Extended 12 hours of continuous illumination for extended prayers and ceremonies' },
          { icon: FaLeaf, title: 'Eco-Friendly', desc: 'Renewable solar energy with zero emissions for environmentally conscious worship' },
          { icon: FiZap, title: '30 Bright LEDs', desc: '30 premium warm-white LEDs arranged in the sacred five-flame pattern' },
          { icon: FiDroplet, title: 'Weather Resistant', desc: 'Suitable for both indoor prayer rooms and outdoor temple spaces' },
          { icon: FiShield, title: '3-Year Warranty', desc: 'Comprehensive warranty coverage for assured longevity' }
        ],
        benefits: [
          ...
          'Zero electricity costs with efficient solar power technology',
          'Automatic dusk-to-dawn operation with intelligent light sensors'
        ],
        images: [SolarBrassSamai], // Use your actual image imports
        reviews: [
