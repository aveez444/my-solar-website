...
const SolarDevdasSamai = () => {
    const product = {
        ...
        price: 2198,
        description: 'Traditional Devdas-style samai with silver detailing, 20 LED lights, 8-hour runtime. Ideal for puja or festive use.',
        extendedDescription: 'Experience the divine elegance of our Solar Silver DevdasSamai. Meticulously crafted with traditional artistry, this samai combines ancient design with modern solar technology.',
        benefits: [
          'Exquisite silver finish with traditional Devdas design',
          'Perfect for puja rooms and festive decorations',
          'Creates a divine atmosphere',
          'No wiring required - solar-powered',
        ],
        images: [SolarSilverDevdasSamai],
        reviews: [
          { name: 'Priya S.', rating: 5, comment: 'Beautiful and bright for puja!' },
          { name: 'Rajesh M.', rating: 5, comment: 'Premium finish, great value.' },
          { name: 'Anjali K.', rating: 4, comment: 'Good design for prayers.' }
        ]
      };
      ...
      const [formData, setFormData] = useState({
        fullName: '', address: '', city: '', zip: '', contact: '', email: '', company: ''
      });
