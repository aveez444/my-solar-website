...
import SolarSilverDevdasSamai from "../assets/images/Products/Samai/SolarSilverDevdasSamai.jpeg";
import { useCart } from '../components/CartContext'; // Adjust path as needed


const SolarDevdasSamai = () => {
    const product = {
        id: 3, // Change ID
        ...
        features: [
          { icon: FiSun, title: 'Solar Powered', desc: 'Charges during daylight, no electricity needed for operation' },
          { icon: FiBatteryCharging, title: '8-Hour Runtime', desc: 'Provides up to 8 hours of continuous divine illumination' },
          { icon: FaLeaf, title: 'Eco-Friendly', desc: 'Zero carbon footprint, completely sustainable lighting solution' },
          { icon: FiZap, title: '20 Bright LEDs', desc: '20 high-quality LED lights for brilliant and even illumination' },
          { icon: FiDroplet, title: 'Weather Resistant', desc: 'Suitable for both indoor and outdoor use' },
          { icon: FiShield, title: '2-Year Warranty', desc: 'Comprehensive warranty for peace of mind' }
        ],
        benefits: [
          ...
          'Maintenance-free operation with automatic dusk-to-dawn sensor'
        ],
        images: [SolarSilverDevdasSamai], // Use your actual image imports
        reviews: [
...
export default SolarDevdasSamai;