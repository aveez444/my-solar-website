...
const SolarLamp = () => {
  const product = {
    ...
    features: [
      { icon: FiSun, title: 'Solar Powered', desc: 'Charges during the day using sunlight, no wiring needed.' },
      { icon: FiBatteryCharging, title: '6-Hour Backup', desc: 'Provides up to 6 hours of bright light on a full charge.' },
      { icon: FaLeaf, title: 'Eco-Friendly', desc: 'Reduces carbon footprint and saves on energy costs.' },
      { icon: FiDroplet, title: 'Weather Resistant', desc: 'IP65 waterproof rating for all-season outdoor use.' },
      { icon: FiZap, title: 'Automatic Operation', desc: 'Dusk-to-dawn sensor turns on/off automatically.' },
      { icon: FiShield, title: '2-Year Warranty', desc: 'Comprehensive warranty coverage for peace of mind.' }
    ],
    benefits: [
      'Zero electricity bills – powered entirely by the sun.',
      'Easy installation – no cables or electricians required.',
      'Long-lasting LED bulbs with high lumen output for bright, efficient lighting.',
      'Enhances safety by illuminating paths and gardens at night.',
      'Contributes to environmental sustainability by using renewable energy.',
      'Automatic features like motion dimming and timers for optimal battery life.'
    ],
    images: [SmallNightLamp, BigNightLamp], // Using available images; can add more
    reviews: [
