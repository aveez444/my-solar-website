...
const AshtavinayakGanpati = () => {
    const product = {
        ...
        features: [
          { icon: FiSun, title: 'Solar Powered', desc: 'Efficient solar charging system for zero electricity cost and eco-friendly operation' },
          { icon: FiBatteryCharging, title: '8-Hour Runtime', desc: 'Reliable illumination throughout evening prayers and ceremonies' },
          { icon: FaLeaf, title: 'Eco-Friendly', desc: 'Sustainable solar energy solution with no carbon footprint' },
          { icon: FiZap, title: '18 Warm White LEDs', desc: 'Soft, warm lighting that enhances spiritual ambiance without being harsh' },
          { icon: FiDroplet, title: 'Weather Resistant', desc: 'Suitable for both indoor puja areas and outdoor spaces like balconies or gardens' },
          { icon: FiShield, title: '2-Year Warranty', desc: 'Comprehensive protection for worry-free ownership' }
        ],
        benefits: [
          ...
          'Completely wireless operation with automatic evening illumination',
          'Makes an ideal gift for housewarmings, weddings, and religious ceremonies'
        ],
