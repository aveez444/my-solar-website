...
const SolarTableTop = () => {
  const product = {
    ...
    images: [TableTop1, TableTop2, TableTop3],
    variations: [
      {
                  ...
                  <div className="space-y-2 sm:space-y-3">
                    ...
                    <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-1 sm:gap-2">
                      ...
                      <motion.button
                        ...
                        className="flex-1 bg-gradient-to-r from-emerald-500 to-green-600 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-lg font-bold shadow-md hover:shadow-emerald-500/25 transition-all duration-300 flex items-center justify-center text-sm sm:text-base"
                      >
                        Buy Now 
